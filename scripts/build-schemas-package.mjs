...
const targetDir = resolve(repoRoot, 'packages/schemas/schemas');
const schemasDir = resolve(repoRoot, 'packages/schemas');
...
console.log(`Copied ${expectedNames.length} schema files to packages/schemas/schemas/`);
