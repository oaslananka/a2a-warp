...
| --------------------------------- | --------------- | --------------- | -------------------------------------------------------------------------------------------- |
| `@oaslananka/a2a-warp`            | `1.2.0`         | `>=22.22.1 <25` | Core runtime, client APIs, auth, telemetry, storage, testing helpers, and Codex-style tools. |
...
| `@oaslananka/a2a-warp-schemas`    | `1.2.0`         | `>=22.22.1 <25` | Standalone JSON Schema files for editor and CI validation.                                   |
