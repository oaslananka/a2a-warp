...
All public packages in the 5.1.x, 6.0.x, 6.1.x, 7.0.x, and 7.1.x lines share the same Node engine
range: `>=22.22.1 <25`.

| Package                                   | Current version | Node range      | Compatibility notes                                                                                              |
| ----------------------------------------- | --------------- | --------------- | ---------------------------------------------------------------------------------------------------------------- |
| `@oaslananka/a2a-warp`                    | `7.1.0`         | `>=22.22.1 <25` | Core runtime, client APIs, storage, testing helpers, and Codex-style tools — re-exports auth and telemetry APIs. |
| `@oaslananka/a2a-warp-adapter-anthropic`  | `7.1.0`         | `>=22.22.1 <25` | Anthropic Claude Messages API adapter.                                                                           |
| `@oaslananka/a2a-warp-adapter-base`       | `7.1.0`         | `>=22.22.1 <25` | Abstract base adapter and contract helpers.                                                                      |
| `@oaslananka/a2a-warp-adapter-crewai`     | `7.1.0`         | `>=22.22.1 <25` | CrewAI HTTP bridge adapter.                                                                                      |
| `@oaslananka/a2a-warp-adapter-google-adk` | `7.1.0`         | `>=22.22.1 <25` | Google Agent Development Kit HTTP adapter.                                                                       |
| `@oaslananka/a2a-warp-adapter-langchain`  | `7.1.0`         | `>=22.22.1 <25` | LangChain / LangGraph runnable adapter.                                                                          |
| `@oaslananka/a2a-warp-adapter-llamaindex` | `7.1.0`         | `>=22.22.1 <25` | LlamaIndex query/chat engine adapter.                                                                            |
| `@oaslananka/a2a-warp-adapter-openai`     | `7.1.0`         | `>=22.22.1 <25` | OpenAI Chat API adapter.                                                                                         |
| `@oaslananka/a2a-warp-adapters`           | `7.1.0`         | `>=22.22.1 <25` | **Deprecated** — use individual `@oaslananka/a2a-warp-adapter-*` packages instead.                               |
| `@oaslananka/a2a-warp-core`               | `7.1.0`         | `>=22.22.1 <25` | Protocol types, interfaces, constants, and validators. Zero runtime dependencies.                                |
...
| `@oaslananka/a2a-warp-registry`           | `7.1.0`         | `>=22.22.1 <25` | Registry server, discovery, health, and storage helpers.                                                         |
| `@oaslananka/a2a-warp-cli`                | `7.1.0`         | `>=22.22.1 <25` | Published `a2a-warp` command-line interface.                                                                     |
| `create-a2a-warp`                         | `7.1.0`         | `>=22.22.1 <25` | Project scaffolder.                                                                                              |
| `@oaslananka/a2a-warp-bridge-mcp`         | `7.1.0`         | `>=22.22.1 <25` | A2A and MCP mapping helpers.                                                                                     |
| `@oaslananka/a2a-warp-transport-ws`       | `7.1.0`         | `>=22.22.1 <25` | WebSocket transport helpers.                                                                                     |
| `@oaslananka/a2a-warp-transport-grpc`     | `7.1.0`         | `>=22.22.1 <25` | gRPC transport helpers.                                                                                          |
| `@oaslananka/a2a-warp-schemas`            | `7.1.0`         | `>=22.22.1 <25` | Standalone JSON Schema files for editor and CI validation.                                                       |
| `@oaslananka/a2a-warp`                    | `7.1.0`         | `>=22.22.1 <25` | Core runtime, client APIs, storage, testing helpers, and Codex-style tools — re-exports auth and telemetry APIs. |
| `@oaslananka/a2a-warp-adapter-anthropic`  | `7.1.0`         | `>=22.22.1 <25` | Anthropic Claude Messages API adapter.                                                                           |
| `@oaslananka/a2a-warp-adapter-base`       | `7.1.0`         | `>=22.22.1 <25` | Abstract base adapter and contract helpers.                                                                      |
| `@oaslananka/a2a-warp-adapter-crewai`     | `7.1.0`         | `>=22.22.1 <25` | CrewAI HTTP bridge adapter.                                                                                      |
...
| `@oaslananka/a2a-warp-transport-grpc`     | `7.1.0`         | `>=22.22.1 <25` | gRPC transport helpers.                                                                                          |
| `@oaslananka/a2a-warp-schemas`            | `7.1.0`         | `>=22.22.1 <25` | Standalone JSON Schema files for editor and CI validation.                                                       |
| `@oaslananka/a2a-warp`                    | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-anthropic`  | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-base`       | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-crewai`     | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-google-adk` | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-langchain`  | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-llamaindex` | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-openai`     | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapters`           | `7.0.0`         | `>=22.22.1 <25` | Previous line — **Deprecated**, use individual packages instead.                                                 |
| `@oaslananka/a2a-warp-core`               | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
...
| `@oaslananka/a2a-warp-registry`           | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-cli`                | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `create-a2a-warp`                         | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-bridge-mcp`         | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-transport-ws`       | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-transport-grpc`     | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-schemas`            | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp`                    | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-anthropic`  | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-base`       | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-crewai`     | `7.0.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
