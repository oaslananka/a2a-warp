...
```powershell
gh api --method POST repos/oaslananka/a2a-warp/rulesets --input .github/rulesets/main.json
gh api --method POST repos/oaslananka/a2a-warp/rulesets --input .github/rulesets/release-tags.json
```

If a ruleset already exists, inspect it and update it by id:

```powershell
gh api repos/oaslananka/a2a-warp/rulesets
gh api --method PUT repos/oaslananka/a2a-warp/rulesets/<ruleset-id> --input .github/rulesets/main.json
```
