...
A2A Warp performs outbound HTTP requests for push notification callbacks, OIDC discovery
...
- [`OutboundPolicy.ts`](../../../packages/core/src/net/OutboundPolicy.ts)
- [`fetchWithPolicy.ts`](../../../packages/core/src/net/fetchWithPolicy.ts)
- [`URL policy property tests`](../../../packages/core/tests/properties/url-policy.property.test.ts)
- [`JwtAuthMiddleware.test.ts`](../../../packages/core/tests/JwtAuthMiddleware.test.ts)
- [`PushNotificationService.test.ts`](../../../packages/core/tests/PushNotificationService.test.ts)
