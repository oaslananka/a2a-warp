...
A2A Warp has two storage domains with different consistency needs.
...
`packages/core/src/server/taskLifecycle.ts`, so storage implementations must not invent
...
- [`ITaskStorage`](../../../packages/core/src/storage/ITaskStorage.ts)
- [`AsyncTaskStorage`](../../../packages/core/src/storage/AsyncTaskStorage.ts)
- [`IAgentStorage`](../../../packages/registry/src/storage/IAgentStorage.ts)
- [`InMemoryTaskStorage.test.ts`](../../../packages/core/tests/InMemoryTaskStorage.test.ts)
- [`AsyncTaskStorage.test.ts`](../../../packages/core/tests/AsyncTaskStorage.test.ts)
- [`SqliteTaskStorage.test.ts`](../../../packages/core/tests/SqliteTaskStorage.test.ts)
