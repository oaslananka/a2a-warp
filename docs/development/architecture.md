...
This document is the canonical architecture map for A2A Warp. It covers the
...
flowchart LR
  ...
  Transports["@oaslananka/a2a-warp-transport-ws<br/>@oaslananka/a2a-warp-transport-grpc"]
  Registry["@oaslananka/a2a-warp-registry"]
  Adapters["@oaslananka/a2a-warp-adapters"]
  Bridges["@oaslananka/a2a-warp-bridge-mcp"]
...
The graph is deliberately conservative. `packages/core` owns protocol types,
...
| `@oaslananka/a2a-warp-transport-ws`   | WebSocket transport helpers and transport-contract coverage for A2A runtime calls over `ws`.                                                                                                                                                                                                                                                                |
| `@oaslananka/a2a-warp-transport-grpc` | gRPC transport helpers and transport-contract coverage for A2A runtime calls over `@grpc/grpc-js`.                                                                                                                                                                                                                                                          |
| `@oaslananka/a2a-warp-bridge-mcp`     | Mapping helpers between A2A agents and MCP tool/skill descriptions. It may use core/client public APIs and MCP SDK types.                                                                                                                                                                                                                                   |
...
| `packages/bridge-mcp` | registry, adapters, CLI, schemas                              |
...
Task mutation rules live in `packages/core/src/server/taskLifecycle.ts` and are used by
...
- [Task lifecycle property tests](../../packages/core/tests/properties/task-lifecycle.property.test.ts)
- [Outbound URL policy property tests](../../packages/core/tests/properties/url-policy.property.test.ts)
...
- [Telemetry snapshot tests](../../packages/core/tests/telemetry-snapshots.test.ts)
