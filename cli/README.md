...
Publishes the `a2a-warp` binary for validation, discovery, messaging, registry management, monitoring, benchmarking, diagnostics, and scaffolding.
...
Run `a2a-warp <command> --help` for usage and options.
