  ...
  examples: [
    {
      ...
      bash: ['a2a-warp validate ./agent-card.json'],
      powershell: ['a2a-warp validate .\\agent-card.json'],
    },
    {
      title: 'Validate an endpoint Agent Card with a timeout.',
      bash: ['a2a-warp validate http://127.0.0.1:3000 --timeout-ms 1000'],
      powershell: ['a2a-warp validate http://127.0.0.1:3000 --timeout-ms 1000'],
    },
  ],
