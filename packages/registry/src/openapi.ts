...
export const registryOpenApiDocument = {
  ...
  info: {
    ...
    version: '1.0.0',
    description:
      'Machine-readable contract for A2A Warp registry discovery, control-plane, metrics, and event-stream endpoints.',
    license: {
      name: 'Apache-2.0',
  ...
  externalDocs: {
    description: 'A2A Warp registry package documentation',
    url: 'https://github.com/oaslananka/a2a-warp/tree/main/docs/packages/registry.md',
  },
  servers: [
    {
    ...
    schemas: {
      ...
      RegistryExportDocument: {
        ...
        properties: {
          $schema: {
            type: 'string',
            const: 'https://oaslananka.github.io/a2a-warp/schemas/registry-export.schema.json',
          },
          schemaVersion: {
            type: 'string',
            const: '1',
