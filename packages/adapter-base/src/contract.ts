/**
 * @file contract.ts
 * Shared adapter contract helpers for text-based provider adapters.
 */

import type { Artifact, ExtensibleArtifact, Part, Task, TextPart } from '@oaslananka/a2a-warp';

export type AdapterCompatibility = 'stable' | 'beta';

interface AdapterContractMetadata {
  provider: string;
