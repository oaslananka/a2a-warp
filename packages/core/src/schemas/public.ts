...
export const publicJsonSchemaDefinitions = [
  {
    ...
    id: 'https://oaslananka.github.io/a2a-warp/schemas/agent-card.schema.json',
    title: 'A2A Warp Agent Card',
    description: 'Agent2Agent Agent Card payloads accepted by A2A Warp.',
    schema: AnyAgentCardSchema,
    source: {
      typeSymbol: 'AnyAgentCard',
      schemaSymbol: 'AnyAgentCardSchema',
      sourceFile: 'packages/core/src/types/agent-card.ts',
    },
  },
  {
    fileName: 'message.schema.json',
    id: 'https://oaslananka.github.io/a2a-warp/schemas/message.schema.json',
    title: 'A2A Warp Message',
    description: 'Agent2Agent message payloads accepted by A2A Warp.',
    schema: MessageSchema,
    source: {
      typeSymbol: 'Message',
      schemaSymbol: 'MessageSchema',
      sourceFile: 'packages/core/src/types/task.ts',
    },
  },
  {
    fileName: 'task.schema.json',
    id: 'https://oaslananka.github.io/a2a-warp/schemas/task.schema.json',
    title: 'A2A Warp Task',
    description: 'Agent2Agent task payloads returned by A2A Warp.',
    schema: TaskSchema,
    source: {
      typeSymbol: 'Task',
  ...
  },
  {
    ...
    id: 'https://oaslananka.github.io/a2a-warp/schemas/artifact.schema.json',
    title: 'A2A Warp Artifact',
  ...
  },
  {
    ...
    id: 'https://oaslananka.github.io/a2a-warp/schemas/json-rpc.schema.json',
    title: 'A2A Warp JSON-RPC Envelope',
    description: 'JSON-RPC 2.0 request and response envelopes used by A2A Warp.',
    schema: JsonRpcEnvelopeSchema,
    source: {
      typeSymbol: 'JsonRpcRequest | JsonRpcResponse',
      schemaSymbol: 'JsonRpcEnvelopeSchema',
      sourceFile: 'packages/core/src/types/jsonrpc.ts',
    },
  },
  {
    fileName: 'registry-agent.schema.json',
    id: 'https://oaslananka.github.io/a2a-warp/schemas/registry-agent.schema.json',
    title: 'A2A Warp Registry Agent',
    description: 'Registered agent payloads returned by the A2A Warp registry.',
  ...
  },
  {
    ...
    id: 'https://oaslananka.github.io/a2a-warp/schemas/registry-task-event.schema.json',
    title: 'A2A Warp Registry Task Event',
    description: 'Task event payloads emitted by the A2A Warp registry.',
