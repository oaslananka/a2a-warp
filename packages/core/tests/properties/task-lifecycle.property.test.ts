...
const TERMINAL_STATES = ['COMPLETED', 'FAILED', 'CANCELED'] as const satisfies readonly TaskState[];
...
const EXPECTED_TRANSITIONS = {
  ...
  WORKING: ['WORKING', 'INPUT_REQUIRED', 'WAITING_ON_EXTERNAL', 'COMPLETED', 'FAILED', 'CANCELED'],
  INPUT_REQUIRED: [
    'INPUT_REQUIRED',
    'WORKING',
    'WAITING_ON_EXTERNAL',
