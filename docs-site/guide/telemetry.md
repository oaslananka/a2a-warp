...
A2A Warp uses [OpenTelemetry](https://opentelemetry.io/) for distributed tracing, metrics, and context propagation.
...
import { withA2ABaggage } from '@oaslananka/a2a-warp';
...
| `OTEL_SERVICE_NAME`                  | `@oaslananka/a2a-warp` | Service name for resource attributes      |
