...
| `@oaslananka/a2a-warp-transport-grpc`     | `7.1.0`         | `>=22.22.1 <25` | gRPC transport helpers.                                                                                          |
| `@oaslananka/a2a-warp-schemas`            | `7.1.0`         | `>=22.22.1 <25` | Standalone JSON Schema files for editor and CI validation.                                                       |
| `@oaslananka/a2a-warp`                    | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-anthropic`  | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-base`       | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-crewai`     | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-google-adk` | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-langchain`  | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-llamaindex` | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-openai`     | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapters`           | `7.1.0`         | `>=22.22.1 <25` | Previous line — **Deprecated**, use individual packages instead.                                                 |
| `@oaslananka/a2a-warp-core`               | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
...
| `@oaslananka/a2a-warp-registry`           | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-cli`                | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `create-a2a-warp`                         | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-bridge-mcp`         | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-transport-ws`       | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-transport-grpc`     | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-schemas`            | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp`                    | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-anthropic`  | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-base`       | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
| `@oaslananka/a2a-warp-adapter-crewai`     | `7.1.0`         | `>=22.22.1 <25` | Previous line — still compatible.                                                                                |
