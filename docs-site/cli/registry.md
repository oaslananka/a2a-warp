...
| Command                    | Summary                                                   |
| -------------------------- | --------------------------------------------------------- |
| `a2a-warp registry start`  | Start a local registry server.                            |
| `a2a-warp registry list`   | List agents registered with a registry.                   |
| `a2a-warp registry export` | Export registry agent state to a versioned JSON document. |
| `a2a-warp registry import` | Import a versioned registry export document.              |
